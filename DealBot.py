...
config = toml.load('config.toml') # Make sure Discord API is inside of the "" in this file!
...
STARTUP_CHECK_ENABLED = True  # Set to False to disable the startup check and post
